          ...
          <div className="w-full">
            <div className="bg-card border border-border rounded-xl p-6 sm:p-8 shadow-sm hover:shadow-md transition-shadow">
              <div className="mb-8">
                ...
                <p className="text-sm sm:text-base text-muted-foreground">Join SarfyDZ and start managing your finances</p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-3 border rounded-lg bg-background text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 transition-all shadow-sm hover:shadow-md ${
                      errors.name ? "border-destructive focus:ring-destructive/30" : "border-border focus:ring-primary/30"
                    }`}
                    placeholder="Khalil Fares BENNABI"
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-3 border rounded-lg bg-background text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 transition-all shadow-sm hover:shadow-md ${
                      errors.password ? "border-destructive focus:ring-destructive/30" : "border-border focus:ring-primary/30"
                    }`}
                    placeholder="••••••••"
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="••••••••"
                  />
                  {errors.confirmPassword && <p className="text-destructive text-xs mt-1.5 font-medium">{errors.confirmPassword}</p>}
                </div>
              ...
              <div className="mt-6 pt-6 border-t border-border">
                <p className="text-muted-foreground text-sm text-center">
                  ...
                  <Link href="/signin" className="bg-gradient-to-r from-cyan-400 to-cyan-300 bg-clip-text text-transparent font-semibold hover:opacity-80 transition-opacity">
                    Sign in
                  </Link>
                </p>
              </div>
